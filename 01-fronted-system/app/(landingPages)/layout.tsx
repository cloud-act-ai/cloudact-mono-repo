          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
            <div className="col-span-2 space-y-4">
              ...
              <div className="flex gap-4">
                <a href="https://twitter.com/cloudact_ai" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[var(--cloudact-bg-mint)] transition-colors text-gray-600 hover:text-mint-text">
                  <span className="sr-only">X (Twitter)</span>
                  <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
                </a>
                <a href="https://linkedin.com/company/cloudact" target="_blank" rel="noopener noreferrer" className="h-8 w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[var(--cloudact-bg-mint)] transition-colors text-gray-600 hover:text-mint-text">
