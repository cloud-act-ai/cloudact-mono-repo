  ...
  return (
    <div className="ca-landing-page">
      ...
      <section className="ca-page-hero">
        <div className="ca-page-hero-content">
          <div className="ca-section-eyebrow" style={{ backgroundColor: '#0f172a', color: '#ffffff' }}>
            <Library className="w-4 h-4" style={{ color: '#ffffff' }} aria-hidden="true" />
            Knowledge Hub
          </div>
          ...
          <form className="ca-resources-search" role="search" aria-label="Search resources" onSubmit={handleSearch}>
            <div className="ca-resources-search-inner">
              ...
              />
              <button type="submit" className="ca-btn-hero-primary ca-resources-search-btn" style={{ backgroundColor: '#90FCA6', color: '#0f172a' }}>
                Search
              </button>
            </div>
          </form>
      ...
      <section className="ca-resources-categories-section">
        <div className="ca-section-header-centered">
          <span className="ca-section-eyebrow" style={{ backgroundColor: '#0f172a', color: '#ffffff' }}>
            <Folders className="w-4 h-4" style={{ color: '#ffffff' }} aria-hidden="true" />
            Browse by Category
          </span>
      ...
      <section className="ca-resources-featured-section">
        <div className="ca-section-header-centered">
          <span className="ca-section-eyebrow" style={{ backgroundColor: '#0f172a', color: '#ffffff' }}>
            <Star className="w-4 h-4" style={{ color: '#ffffff' }} aria-hidden="true" />
            Featured Content
          </span>
        ...
        <div className="ca-resources-view-all">
          <Link href="/resources/all" className="ca-btn-hero-primary" style={{ backgroundColor: '#90FCA6', color: '#0f172a' }}>
            View All Resources
            <ArrowRight className="w-5 h-5" aria-hidden="true" />
          </Link>
        </div>
      ...
      <section className="ca-resources-downloads-section">
        <div className="ca-section-header-centered">
          <span className="ca-section-eyebrow" style={{ backgroundColor: '#0f172a', color: '#ffffff' }}>
            <Download className="w-4 h-4" style={{ color: '#ffffff' }} aria-hidden="true" />
            Free Downloads
          </span>
          ...
          {QUICK_LINKS.map((link) => {
            ...
            return (
              <div key={link.title} className="ca-resources-quicklink-card">
                ...
                <Link href={link.href} className="ca-btn-hero-secondary" style={{ backgroundColor: '#ffffff', color: '#0f172a', border: '1px solid #e2e8f0' }}>
                  {link.cta}
                </Link>
              </div>
            )
      ...
      <section className="ca-final-cta-section">
        <div className="ca-final-cta-container">
          ...
          <div className="ca-final-cta-buttons">
            ...
            <Link href="/docs" className="ca-btn-cta-secondary" style={{ backgroundColor: '#ffffff', color: '#0f172a', border: '1px solid #e2e8f0' }}>
              View Documentation
            </Link>
          </div>
        </div>
