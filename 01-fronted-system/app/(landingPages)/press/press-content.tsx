    ...
    <div className="ca-landing-page">
      ...
      <section className="ca-page-hero">
        <div className="ca-page-hero-content">
          <div className="ca-section-eyebrow" style={eyebrowBadgeStyle}>
            <Newspaper className="w-4 h-4" style={eyebrowIconStyle} aria-hidden="true" />
            Press & Media
          </div>
      ...
      <section className="ca-section-white">
        <div className="ca-section-container">
          <div className="ca-section-header-centered">
            <span className="ca-section-eyebrow" style={eyebrowBadgeStyle}>
              <FileText className="w-4 h-4" style={eyebrowIconStyle} aria-hidden="true" />
              Press Releases
            </span>
      ...
      <section className="ca-section-gray">
        <div className="ca-section-container">
          <div className="ca-section-header-centered">
            <span className="ca-section-eyebrow" style={eyebrowBadgeStyle}>
              <Download className="w-4 h-4" style={eyebrowIconStyle} aria-hidden="true" />
              Media Resources
            </span>
      ...
      <section className="ca-final-cta-section">
        <div className="ca-final-cta-container">
          ...
          <div className="ca-final-cta-buttons">
            <Link href="/demo" className="ca-btn-cta-primary" style={primaryButtonStyle}>
              Request Demo
              <ArrowRight className="w-5 h-5" aria-hidden="true" />
            </Link>
            <Link href="/about" className="ca-btn-cta-secondary" style={secondaryButtonStyle}>
              About Us
            </Link>
          </div>
        </div>
