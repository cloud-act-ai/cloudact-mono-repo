  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-[13px] sm:text-[15px] text-muted-foreground mt-1">Manage your settings</p>
      </div>

      <div className="health-card">
        <div className="mb-4">
          <h2 className="text-[17px] font-semibold text-black">Organization Settings</h2>
          <p className="text-[13px] text-muted-foreground mt-0.5">Configure your workspace</p>
        </div>
        <div>
