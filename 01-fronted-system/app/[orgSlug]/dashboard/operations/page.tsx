  ...
  return (
    <div className="space-y-6 sm:space-y-8">
      <div>
        ...
        <p className="text-[13px] sm:text-[15px] text-muted-foreground mt-1">Monitor and manage operations</p>
      </div>

      <div className="health-card">
        <div className="mb-4">
          <h2 className="text-[17px] font-semibold text-black">Operations Dashboard</h2>
          <p className="text-[13px] text-muted-foreground mt-0.5">Coming soon</p>
        </div>
        <div>
