...
const PROVIDER_GRADIENTS: Record<string, string> = {
  gcp: "from-[var(--cloudact-mint)] to-[var(--cloudact-mint-light)]",
  aws: "from-[var(--cloudact-coral)] to-[var(--cloudact-coral-light)]",
  azure: "from-[var(--cloudact-mint)] to-[var(--cloudact-mint-dark)]",
}
        ...
        <div className="flex items-start justify-between gap-6 mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link href={`/${orgSlug}/integrations/cloud-providers`}>
              <button className="h-11 px-5 bg-[var(--cloudact-mint)] hover:bg-[#7EFC9E] text-white text-[13px] font-semibold rounded-xl transition-colors flex items-center gap-2 shadow-sm">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[var(--cloudact-mint)]/10 flex items-center justify-center">
              <Cloud className="h-5 w-5 text-[var(--cloudact-mint-text)]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[var(--cloudact-mint)]/10 flex items-center justify-center">
              <Server className="h-5 w-5 text-[var(--cloudact-mint-text)]" />
            </div>
            <div>
          ...
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[var(--cloudact-coral)]/10 flex items-center justify-center">
              <DollarSign className="h-5 w-5 text-[var(--cloudact-coral)]" />
            </div>
            <div>
      ...
      {summary && summary.providers_count > 0 && (
        <section className="mb-10">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[11px] text-[var(--cloudact-mint-text)] font-semibold bg-[var(--cloudact-mint)]/10 px-2 py-0.5 rounded-full">
                ...
                >
                  ...
                  <div className="relative">
                    <div className="flex items-center justify-between mb-4">
                      <Cloud className={`h-8 w-8 ${provider === 'gcp' ? 'text-[var(--cloudact-mint-text)]' : provider === 'aws' ? 'text-[var(--cloudact-coral)]' : 'text-[var(--cloudact-mint-dark)]'}`} />
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="metric-card group hover:shadow-xl transition-all duration-300">
              <div className="metric-card-header">
                <div className="metric-card-label metric-card-label-coral">
                  <div className="p-2 rounded-xl bg-[var(--cloudact-coral)]/10 group-hover:bg-[var(--cloudact-coral)]/20 transition-colors">
              ...
              <div className="metric-card-content">
                <div className="metric-card-value bg-gradient-to-r from-[var(--cloudact-coral)] to-[var(--cloudact-coral-light)] bg-clip-text text-transparent">
            ...
            <div className="metric-card group hover:shadow-xl transition-all duration-300">
              ...
              <div className="metric-card-content">
                ...
                <div className="flex items-center gap-2 mt-2">
                  <div className="inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-[var(--cloudact-mint)]/10 text-[var(--cloudact-mint-text)] text-[12px] font-semibold">
            ...
            <div className="metric-card group hover:shadow-xl transition-all duration-300">
              <div className="metric-card-header">
                <div className="metric-card-label metric-card-label-coral-dark">
                  <div className="p-2 rounded-xl bg-[var(--cloudact-coral-dark)]/10 group-hover:bg-[var(--cloudact-coral-dark)]/20 transition-colors">
            ...
            {/* Active Providers */}
            <div className="metric-card group hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-[var(--cloudact-mint-dark)]/5">
              <div className="metric-card-header">
                <div className="metric-card-label metric-card-label-teal">
                  <div className="p-2 rounded-xl bg-[var(--cloudact-mint)]/10 group-hover:bg-[var(--cloudact-mint)]/20 transition-colors">
              ...
              <div className="metric-card-content">
                <div className="metric-card-value bg-gradient-to-r from-[var(--cloudact-mint)] to-[var(--cloudact-mint-light)] bg-clip-text text-transparent">
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="metric-card relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--cloudact-coral)]/5 rounded-full blur-3xl group-hover:bg-[var(--cloudact-coral)]/10 transition-colors"></div>
              ...
              <div className="relative">
                ...
                <div className="metric-card-content">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Zap className="h-3.5 w-3.5 text-[var(--cloudact-coral)]" />
            ...
            {/* Annual Forecast */}
            <div className="metric-card relative overflow-hidden group hover:shadow-xl transition-all duration-300">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--cloudact-coral-dark)]/5 rounded-full blur-3xl group-hover:bg-[var(--cloudact-coral-dark)]/10 transition-colors"></div>
            ...
            {/* Active Services */}
            <div className="metric-card col-span-2 lg:col-span-1 relative overflow-hidden group hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white to-[var(--cloudact-mint-dark)]/5">
              <div className="absolute top-0 right-0 w-32 h-32 bg-[var(--cloudact-mint)]/5 rounded-full blur-3xl group-hover:bg-[var(--cloudact-mint)]/10 transition-colors"></div>
              ...
              <div className="relative">
                ...
                <div className="metric-card-content">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <BarChart3 className="h-3.5 w-3.5 text-[var(--cloudact-mint-text)]" />
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden shadow-sm">
          {costRecords.length === 0 ? (
            <div className="text-center py-16 sm:py-20 px-4 sm:px-6 relative">
              <div className="absolute inset-0 bg-gradient-to-br from-[var(--cloudact-mint)]/5 via-transparent to-[var(--cloudact-coral)]/5 pointer-events-none"></div>

              <div className="relative">
                <div className="inline-flex p-5 rounded-3xl bg-gradient-to-br from-[var(--cloudact-mint)]/10 to-[var(--cloudact-mint-dark)]/5 mb-6 shadow-lg border border-[var(--cloudact-mint)]/10">
                  <Cloud className="h-16 w-16 text-[var(--cloudact-mint)]" />
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href={`/${orgSlug}/pipelines/cost-runs`}>
                    <Button variant="outline" className="console-button-secondary h-12 px-7 rounded-xl text-[16px] font-semibold border-2 hover:bg-[var(--cloudact-mint)]/5 transition-all group">
                        ...
                        <TableCell className="py-3">
                          <div className="flex items-center gap-3">
                            <div className="p-2 rounded-lg bg-[var(--cloudact-mint)]/10">
                              <ServiceIcon className="h-4 w-4 text-[var(--cloudact-mint-text)]" />
                            </div>
