      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4">
        <div className="flex items-center gap-3">
          <div className="p-2 sm:p-2.5 rounded-xl bg-[var(--cloudact-mint)]/10">
            <Brain className="h-5 w-5 sm:h-6 sm:w-6 text-[var(--cloudact-mint-text)]" />
          </div>
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-slate-900">GenAI Costs</h1>
            <p className="text-xs sm:text-sm text-slate-500">LLM API usage and spend</p>
          </div>
        </div>
        <Button
      ...
      {!summary && providers.length === 0 && (
        <div className="bg-white rounded-xl sm:rounded-2xl border border-slate-200 p-8 sm:p-12 text-center">
          <div className="inline-flex p-3 sm:p-4 rounded-xl sm:rounded-2xl bg-[var(--cloudact-mint)]/10 mb-3 sm:mb-4">
            <Brain className="h-8 w-8 sm:h-10 sm:w-10 text-[var(--cloudact-mint-text)]" />
          </div>
          <h3 className="text-base sm:text-lg font-semibold text-slate-900 mb-2">No GenAI costs yet</h3>
