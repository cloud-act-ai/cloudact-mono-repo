  ...
  return (
    <div className="space-y-6 sm:space-y-8 max-w-2xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          onClick={reset}
          className="inline-flex items-center justify-center gap-2 h-[44px] px-6 bg-mint text-mint-text text-[14px] font-semibold rounded-xl hover:bg-mint-dark transition-colors"
        >
