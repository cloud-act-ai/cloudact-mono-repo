    ...
    return (
      <div className="flex items-center justify-center min-h-[500px]">
        <div className="text-center">
          ...
          <p className="text-[13px] text-[var(--text-tertiary)] font-medium">Loading team members...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          <div className="flex items-start gap-3 sm:gap-4">
            <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl sm:rounded-2xl bg-gradient-to-br from-[#90FCA6] to-[#B8FDCA] flex items-center justify-center flex-shrink-0 shadow-sm">
              <Users className="h-5 w-5 sm:h-6 sm:w-6 text-[var(--text-primary)]" />
            </div>
            <div>
            ...
            <Dialog open={isInviteDialogOpen} onOpenChange={(open) => {
              ...
              <DialogTrigger asChild>
                <button
                  ...
                  className="h-10 sm:h-11 w-full sm:w-auto px-5 sm:px-6 text-[11px] sm:text-[12px] font-semibold bg-[#90FCA6] hover:bg-[#6EE890] text-[var(--text-primary)] rounded-lg sm:rounded-xl transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed touch-manipulation"
                >
                ...
                {inviteLink ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <Input value={inviteLink} readOnly className="text-[12px] rounded-xl border-[var(--border-medium)] focus:border-[#90FCA6] focus:ring-[#90FCA6]/20" />
                      <Button onClick={copyInviteLink} variant="outline" className="rounded-xl" aria-label="Copy invite link">
                        {copied ? <CheckCircle2 className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                      </Button>
                    </div>
                    <button
                      className="w-full h-11 text-[12px] font-semibold bg-[#90FCA6] hover:bg-[#6EE890] text-[var(--text-primary)] rounded-xl transition-all shadow-sm hover:shadow-md"
                      onClick={() => {
                        setInviteLink(null)
                  ...
                  <div className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="email" className="text-[12px] font-medium text-[var(--text-secondary)]">Email address</Label>
                      <Input
                        id="email"
                        name="invite-email"
                        type="email"
                        ...
                        className="h-10 text-[12px] rounded-xl border-[var(--border-medium)] focus:border-[#90FCA6] focus:ring-[#90FCA6]/20"
                      />
                      {emailError && (
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="role" className="text-[12px] font-medium text-[var(--text-secondary)]">Role</Label>
                      <Select value={inviteRole} onValueChange={(v: "collaborator" | "read_only") => setInviteRole(v)} disabled={isInviting}>
                        <SelectTrigger className="h-10 rounded-xl border-[var(--border-medium)] focus:border-[#90FCA6] focus:ring-[#90FCA6]/20">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
        <div className="metric-card p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="min-w-0">
              <p className="text-[18px] sm:text-[24px] font-bold text-[var(--text-primary)] leading-none tracking-tight">{currentSeats}</p>
              <p className="text-xs sm:text-[12px] text-[var(--text-tertiary)] font-medium mt-0.5 sm:mt-1 truncate">
                of {seatLimit ?? "∞"} seats
              </p>
            </div>
          </div>
        ...
        <div className="metric-card p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="min-w-0">
              <p className="text-[18px] sm:text-[24px] font-bold text-[var(--text-primary)] leading-none tracking-tight">{invites.length}</p>
              <p className="text-xs sm:text-[12px] text-[var(--text-tertiary)] font-medium mt-0.5 sm:mt-1 truncate">pending</p>
            </div>
          </div>
        </div>
        ...
        <div className="metric-card p-3 sm:p-4">
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <div className="min-w-0">
              <p className="text-[18px] sm:text-[24px] font-bold text-[var(--text-primary)] leading-none tracking-tight">{seatsAvailable}</p>
              <p className="text-xs sm:text-[12px] text-[var(--text-tertiary)] font-medium mt-0.5 sm:mt-1 truncate">available</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {seatsAvailable <= 0 && seatLimit && isOwner && (
        <div className="mb-6 p-4 rounded-xl bg-[#FF6C5E]/10 border border-[#FF6C5E]/30 flex items-center justify-between gap-4">
          ...
          <a
            ...
            className="text-[12px] font-semibold text-[var(--text-primary)] hover:underline"
          >
            Upgrade plan →
          </a>
        </div>
        ...
        <div className="console-table-card">
          {members.length === 0 ? (
            <div className="py-16 text-center">
              ...
              <h3 className="text-[16px] font-semibold text-[var(--text-primary)] mb-1">No team members yet</h3>
              <p className="text-[12px] text-[var(--text-tertiary)] mb-6 max-w-xs mx-auto">
              ...
              {isOwner && (
                <button
                  ...
                  disabled={!seatLimit || seatsAvailable <= 0}
                  className="h-11 px-6 text-[12px] font-semibold bg-[#90FCA6] hover:bg-[#6EE890] text-[var(--text-primary)] rounded-xl transition-all shadow-sm hover:shadow-md inline-flex items-center gap-2 disabled:opacity-50"
                >
                  <UserPlus className="h-4 w-4" />
                  Invite Member
                </button>
                  ...
                  <div className="console-table-cell pl-5 py-4 pr-5 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-4 min-w-0 flex-1">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="text-[12px] text-[var(--text-tertiary)] truncate mt-0.5">{member.profiles?.email || "No email"}</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2 flex-shrink-0">
                      {isOwner && member.role !== "owner" ? (
                        ...
                        >
                          <SelectTrigger className="w-[140px] h-9 text-[11px] border-[var(--border-medium)] rounded-lg">
                            <SelectValue />
                          </SelectTrigger>
                          <SelectContent>
                        ...
                        <Badge
                          className={`text-[11px] font-semibold px-3 py-1.5 rounded-lg ${
                            member.role === "owner"
                              ...
                              : "bg-[var(--surface-secondary)] text-[var(--text-secondary)] border-0"
                          }`}
                        >
                      ...
                      {isOwner && (
                        <div className="flex items-center gap-1">
                          ...
                          <button
                            ...
                            className="h-9 px-4 rounded-lg text-[11px] font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] hover:bg-[var(--surface-hover)] transition-colors"
                          >
                            Cancel
                          </button>
                        </div>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="metric-card">
            ...
            <h3 className="text-[14px] font-semibold text-[var(--text-primary)] mb-1">Owner</h3>
            <p className="text-[12px] text-[var(--text-tertiary)] mb-4">Full access to everything</p>
            <div className="space-y-2">
              {["View data", "Edit data", "Invite members", "Manage roles", "Access billing"].map((perm) => (
                <div key={perm} className="flex items-center gap-2">
                  <Check className="h-4 w-4 text-[#1a7a3a]" />
                  <span className="text-[12px] text-[var(--text-secondary)]">{perm}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="metric-card">
            ...
            <h3 className="text-[14px] font-semibold text-[var(--text-primary)] mb-1">Collaborator</h3>
            <p className="text-[12px] text-[var(--text-tertiary)] mb-4">Can view and edit data</p>
            <div className="space-y-2">
              {[
          ...
          {/* Read Only */}
          <div className="metric-card">
            <div className="h-12 w-12 rounded-2xl bg-[var(--surface-secondary)] flex items-center justify-center mb-4 shadow-sm">
              <Eye className="h-6 w-6 text-[var(--text-secondary)]" />
            </div>
            <h3 className="text-[14px] font-semibold text-[var(--text-primary)] mb-1">Read Only</h3>
            <p className="text-[12px] text-[var(--text-tertiary)] mb-4">View access only</p>
            <div className="space-y-2">
              {[
                { perm: "View data", allowed: true },
