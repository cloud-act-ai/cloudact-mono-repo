...
export default function DangerZoneError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === "development") {
      console.error("[Settings/Danger] Error:", error)
    }
    ...
    <div className="container mx-auto py-10 max-w-2xl">
      <Card className="border-[#FF6E50]/30">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            We encountered an error while loading settings. This could be a temporary issue.
          </CardDescription>
        </CardHeader>
