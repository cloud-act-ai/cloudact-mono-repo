...
>(({ className, inset, children, ...props }, ref) => (
  ...
  >
    {children}
    <ChevronRightIcon className="ml-auto h-4 w-4 text-[#8E8E93]" />
  </MenubarPrimitive.SubTrigger>
))
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.SubContent
    ref={ref}
    style={{ zIndex: 'var(--z-dropdown, 20)' as unknown as number }}
    className={cn(
  ...
  (
    ...
    <MenubarPrimitive.Portal>
      <MenubarPrimitive.Content
        ...
        style={{ zIndex: 'var(--z-dropdown, 20)' as unknown as number }}
        className={cn(
          "min-w-[12rem] overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-lg",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          "data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2",
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Label
    ref={ref}
    className={cn(
      "px-2 py-1.5 text-xs font-semibold text-[#8E8E93]",
      inset && "pl-8",
      className
    )}
    {...props}
