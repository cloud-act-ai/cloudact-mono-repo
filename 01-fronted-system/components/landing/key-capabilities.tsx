      ...
      <div className="container px-4 mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-[2.75rem] font-bold text-slate-900 tracking-tight mb-4">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-start gap-4 mb-3">
                  ...
                  <h3 className="text-lg font-bold text-slate-900 pt-1.5">{cap.title}</h3>
                </div>
