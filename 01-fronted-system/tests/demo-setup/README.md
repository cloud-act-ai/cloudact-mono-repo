...
export ORG_SLUG="acme_inc_ml01ua8p"  # Use actual slug from step 1 (timestamp-based)
...
| Field | Value | Notes |
|-------|-------|-------|
| Email | `demo@cloudact.ai` | Default demo user |
| Password | `demo1234` | Default password |
| First Name | `John` | |
| Last Name | `Doe` | |
| Phone | `5551234567` | |
...
| **Org Slug** | `acme_inc_{timestamp}` | **Auto-generated at signup** (e.g., `acme_inc_ml01ua8p`) |
...
|--------|-------------|---------|
| `--email=` | Account email | `demo@cloudact.ai` |
