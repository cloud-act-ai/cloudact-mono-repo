// @ts-nocheck
import { default as __fd_glob_18 } from "../content/docs/billing/meta.json?collection=meta"
import { default as __fd_glob_17 } from "../content/docs/integrations/meta.json?collection=meta"
...
export const docs = await create.doc("docs", "content/docs", {"index.mdx": __fd_glob_0, "billing/index.mdx": __fd_glob_1, "billing/invoices.mdx": __fd_glob_2, "billing/plans.mdx": __fd_glob_3, "account/index.mdx": __fd_glob_4, "account/profile.mdx": __fd_glob_5, "account/security.mdx": __fd_glob_6, "account/team.mdx": __fd_glob_7, "getting-started/index.mdx": __fd_glob_8, "getting-started/quickstart.mdx": __fd_glob_9, "integrations/anthropic.mdx": __fd_glob_10, "integrations/gcp.mdx": __fd_glob_11, "integrations/index.mdx": __fd_glob_12, "integrations/openai.mdx": __fd_glob_13, });

export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_14, "account/meta.json": __fd_glob_15, "getting-started/meta.json": __fd_glob_16, "integrations/meta.json": __fd_glob_17, "billing/meta.json": __fd_glob_18, });