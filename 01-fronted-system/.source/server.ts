...
export const meta = await create.meta("meta", "content/docs", {"meta.json": __fd_glob_14, "account/meta.json": __fd_glob_15, "getting-started/meta.json": __fd_glob_16, "billing/meta.json": __fd_glob_17, "integrations/meta.json": __fd_glob_18, });