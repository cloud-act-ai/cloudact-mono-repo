...
**CloudAct Extensions (N-Level Hierarchy v14.0):**

| Field | Description |
|-------|-------------|
| `x_hierarchy_entity_id` | Hierarchy entity ID |
| `x_hierarchy_entity_name` | Hierarchy entity name |
| `x_hierarchy_level_code` | Entity's level code (e.g., department, project, team) |
| `x_hierarchy_path` | Materialized path (e.g., /DEPT-001/PROJ-001/TEAM-001) |
