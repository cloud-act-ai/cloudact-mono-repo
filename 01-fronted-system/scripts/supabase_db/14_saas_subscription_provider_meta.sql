...
CREATE TABLE IF NOT EXISTS subscription_providers_meta (
...
CREATE INDEX IF NOT EXISTS idx_subscription_providers_meta_org_id
    ON subscription_providers_meta(org_id);

CREATE INDEX IF NOT EXISTS idx_subscription_providers_meta_enabled
    ON subscription_providers_meta(org_id, is_enabled);

CREATE INDEX IF NOT EXISTS idx_subscription_providers_meta_provider
