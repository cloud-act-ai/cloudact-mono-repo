...
|-------|-------------|--------|
| `genai_costs_daily_unified` | GenAI costs from usage + pricing | sp_consolidate_genai_costs_daily |
| `subscription_plan_costs_daily` | Daily amortized subscription costs | sp_calculate_subscription_plan_costs_daily |
