...
if [ "$SERVICE" = "frontend" ]; then
    ...
    # SUPABASE_URL is for server-side code (runtime), NEXT_PUBLIC_SUPABASE_URL is for client-side (build-time)
    ENV_VARS="${ENV_VARS},SUPABASE_URL=${SUPABASE_URL},NEXT_PUBLIC_SUPABASE_URL=${SUPABASE_URL},NEXT_PUBLIC_SUPABASE_ANON_KEY=${SUPABASE_ANON_KEY}"
