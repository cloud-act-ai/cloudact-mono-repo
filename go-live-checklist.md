...
| Auth                                    | Signup                 | Org Slug                      | Auto                        | company_{ts}      | PENDING | -                 |
...
| **CONSOLE - DASHBOARD**                 |                        |                               |                             |                   |         |                   |
| Console                                 | Dashboard              | Overview                      | GET                         | Renders           | PASS    | Code verified     |
| Console                                 | Dashboard              | Cost Summary                  | Widget                      | Total             | PASS    | Code verified     |
| Console                                 | Dashboard              | Trend Chart                   | Widget                      | 30-day            | PASS    | Code verified     |
| Console                                 | Dashboard              | Top Providers                 | Widget                      | Breakdown         | PASS    | Code verified     |
| Console                                 | Dashboard              | Activity                      | Widget                      | Last 10           | PASS    | Code verified     |
| Console                                 | Dashboard              | Quick Actions                 | Buttons                     | Work              | PASS    | Code verified     |
| Console                                 | Dashboard              | Date Range                    | Filter                      | Updates           | PASS    | Code verified     |
| Console                                 | Dashboard              | Refresh                       | Button                      | Reloads           | PASS    | Code verified     |
| Console                                 | Dashboard              | Loading                       | Skeleton                    | Shows             | PASS    | Code verified     |
| Console                                 | Dashboard              | Error                         | State                       | Shows             | PASS    | Code verified     |
| Console                                 | Dashboard              | Empty State                   | No data                     | Shows msg         | PASS    | Code verified     |
| Console                                 | Dashboard              | Currency Display              | Locale                      | Formatted         | PASS    | Code verified     |
| **CONSOLE - CLOUD COSTS**               |                        |                               |                             |                   |         |                   |
| Console                                 | Cloud                  | Overview                      | GET                         | Summary           | PASS    | Code verified     |
| Console                                 | Cloud                  | GCP Tab                       | Click                       | GCP               | PASS    | Code verified     |
| Console                                 | Cloud                  | AWS Tab                       | Click                       | AWS               | PASS    | Code verified     |
| Console                                 | Cloud                  | Azure Tab                     | Click                       | Azure             | PASS    | Code verified     |
| Console                                 | Cloud                  | OCI Tab                       | Click                       | OCI               | PASS    | Code verified     |
| Console                                 | Cloud                  | Service Table                 | Breakdown                   | Shows             | PASS    | Code verified     |
| Console                                 | Cloud                  | Export CSV                    | Button                      | Downloads         | PASS    | Code verified     |
| Console                                 | Cloud                  | Export PDF                    | Button                      | Downloads         | PASS    | Code verified     |
| Console                                 | Cloud                  | Empty State                   | No data                     | Shows msg         | PASS    | Code verified     |
| Console                                 | Cloud                  | Caching                       | TTL                         | 5min cache        | PASS    | Code verified     |
| **CONSOLE - GENAI COSTS**               |                        |                               |                             |                   |         |                   |
| Console                                 | GenAI                  | Overview                      | GET                         | Summary           | PASS    | Code verified     |
| Console                                 | GenAI                  | OpenAI Tab                    | Click                       | OpenAI            | PASS    | Code verified     |
| Console                                 | GenAI                  | Anthropic Tab                 | Click                       | Anthropic         | PASS    | Code verified     |
| Console                                 | GenAI                  | Gemini Tab                    | Click                       | Gemini            | PASS    | Code verified     |
| Console                                 | GenAI                  | Bedrock Tab                   | Click                       | AWS Bedrock       | PASS    | Code verified     |
| Console                                 | GenAI                  | Vertex Tab                    | Click                       | GCP Vertex        | PASS    | Code verified     |
| Console                                 | GenAI                  | Token Chart                   | Usage                       | Shows             | PASS    | Code verified     |
| Console                                 | GenAI                  | Model Table                   | Breakdown                   | Shows             | PASS    | Code verified     |
| Console                                 | GenAI                  | Cost/Token                    | Calc                        | Rate              | PASS    | Code verified     |
| Console                                 | GenAI                  | Empty State                   | No data                     | Shows msg         | PASS    | Code verified     |
...
| Console                                 | Integrations           | List                          | GET                         | Providers         | PASS    | Code verified     |
| Console                                 | Integrations           | GCP                           | POST                        | Service Acct      | PASS    | Code verified     |
| Console                                 | Integrations           | AWS                           | POST                        | IAM Role          | PASS    | Code verified     |
| Console                                 | Integrations           | Azure                         | POST                        | SP                | PASS    | Code verified     |
| Console                                 | Integrations           | OCI                           | POST                        | Config            | PASS    | Code verified     |
| Console                                 | Integrations           | OpenAI                        | POST                        | API Key           | PASS    | Code verified     |
| Console                                 | Integrations           | Anthropic                     | POST                        | API Key           | PASS    | Code verified     |
| Console                                 | Integrations           | Gemini                        | POST                        | API Key           | PASS    | Code verified     |
| Console                                 | Integrations           | Azure OpenAI                  | POST                        | API Key           | PASS    | Code verified     |
| Console                                 | Integrations           | AWS Bedrock                   | POST                        | IAM + Region      | PASS    | Code verified     |
| Console                                 | Integrations           | GCP Vertex                    | POST                        | Service Acct      | PASS    | Code verified     |
| Console                                 | Integrations           | Validate                      | POST                        | Tests             | PASS    | Code verified     |
| Console                                 | Integrations           | Delete                        | DELETE                      | Removes           | PASS    | Code verified     |
| Console                                 | Integrations           | Sync Status                   | Badge                       | Last              | PASS    | Code verified     |
| Console                                 | Integrations           | Manual Sync                   | Button                      | Triggers          | PASS    | Code verified     |
| Console                                 | Integrations           | Encryption                    | KMS                         | AES-256           | PASS    | Code verified     |
| Console                                 | Integrations           | Permission Check              | Validate                    | IAM roles         | PASS    | Code verified     |
| Console                                 | Integrations           | Empty State                   | No data                     | Shows msg         | PASS    | Code verified     |
| **CONSOLE - ALERTS (NEW)**              |                        |                               |                             |                   |         |                   |
...
| Console                                 | Org                    | View                          | GET                         | Config            | PASS    | Code verified     |
| Console                                 | Org                    | Name                          | PUT                         | Updates           | PASS    | Code verified     |
| Console                                 | Org                    | Logo                          | POST                        | Uploads           | PASS    | Code verified     |
| Console                                 | Org                    | Currency                      | Dropdown                    | Locale            | PASS    | Code verified     |
| Console                                 | Org                    | Timezone                      | Dropdown                    | Locale            | PASS    | Code verified     |
| Console                                 | Org                    | Date Format                   | Dropdown                    | Locale            | PASS    | Code verified     |
| Console                                 | Org                    | Fiscal Year                   | Dropdown                    | Start month       | PASS    | Code verified     |
| Console                                 | Org                    | Delete Org                    | DELETE                      | Full delete       | PASS    | Code verified     |
| Console                                 | Org                    | Export All Data               | GET                         | GDPR export       | PASS    | Code verified     |
| Console                                 | Org                    | Transfer Ownership            | PUT                         | New owner         | PASS    | Code verified     |
...
| **CONSOLE - UI/UX**                     |                        |                               |                             |                   |         |                   |
| Console                                 | UI                     | Dark Mode                     | Toggle                      | Switches          | PASS    | Code verified     |
| Console                                 | UI                     | Responsive                    | Mobile                      | Works             | PASS    | Code verified     |
| Console                                 | UI                     | Breadcrumbs                   | Nav                         | Shows             | PASS    | Code verified     |
| Console                                 | UI                     | Loading States                | All pages                   | Shows             | PASS    | Code verified     |
| Console                                 | UI                     | Error States                  | All pages                   | Shows             | PASS    | Code verified     |
| Console                                 | UI                     | Toast Messages                | Actions                     | Shows             | PASS    | Code verified     |
| Console                                 | UI                     | Confirmation Modals           | Destructive                 | Confirms          | PASS    | Code verified     |
| Console                                 | UI                     | Accessibility                 | a11y                        | WCAG 2.1          | PASS    | Code verified     |
| **CONSOLE - AUDIT**                     |                        |                               |                             |                   |         |                   |
...
_Updated: 2026-01-28 03:30 UTC_
