...
│  Creates: organizations dataset (21 meta tables)                        │
...
│  ┌───────────────────────────────────────────────────────────────────┐  │
│  │ 21 meta tables (org_subscriptions, genai_payg_pricing, etc.)      │  │
...
| Bootstrap | pytest + BigQuery | 21 meta tables created, stored procedures deployed |
